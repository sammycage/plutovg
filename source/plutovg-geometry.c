...
{
    double a = 0, da = 0, hda = 0, kappa = 0;
    double dx = 0, dy = 0, x = 0, y = 0, tanx = 0, tany = 0;
    ...
    ndivs = MAX(1, MIN((int)(fabs(da) / (M_PI*0.5) + 0.5), 5));
